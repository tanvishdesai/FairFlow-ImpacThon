...
def train_models():
    print("Loading data...")
    # Load data using existing utility (which handles encoding, scaling, splitting)
    ...
    y_train = data["y_train"] # This is a Series/DataFrame
    
    # Ensure y is 1D array
    y_train = y_train.values.ravel()

    models_dir = Path("models/german_credit")
